execute @s[tag=staffstatus,scores={aafkmtoggle=1}] ~~~ scoreboard players set AFK_Timer AFK3 3600
...
execute @s[tag=staffstatus] ~~~ tellraw @a[tag=staffstatus,scores={aafkmtoggle=1}] {"rawtext":[{"text":"§¶§cUAC §¶§b► §6Anti AFK Timer §bhas been set to §21 Hour §bby §d"},{"selector":"@s"}]}
